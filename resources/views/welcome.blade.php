        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="{{ asset('latar/logo.png') }}" class="mx-auto d-block" width="60%">
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a class="text-gray-900 dark:text-white">Teledokter</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Teledokter adalah pelayanan konsultasi dari aplikasi pihak ke-3 yang dilakukan secara jarak jauh untuk membantu menegakkan diagnosis dan/atau memberi pertimbangan atau saran tata laksana.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a class="text-gray-900 dark:text-white">Diskusi</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Diskusi adalah suatu interaksi komunikasi yang terjadi antara dua orang atau secara berkelompok dimana tujuannya untuk membahas suatu tema atau topik seputar HIV/AIDS untuk mengeluarkan aspirasi.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Postingan</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Posting berasal dari kata post yang artinya adalah kirim atau publish yang dikirim oleh admin untuk dilihat oleh semua member pada aplikasi Gaoel Sehat-i
                                </div>
                            </div>
                        </div>
                    </div>
